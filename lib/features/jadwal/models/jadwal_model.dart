...
JadwalAll jadwalAllFromJson(String str) => JadwalAll.fromJson(json.decode(str));

String jadwalAllToJson(JadwalAll data) => json.encode(data.toJson());
...
class JadwalAll {
    ...
    factory JadwalAll.fromJson(Map<String, dynamic> json) => JadwalAll(
        status: json["status"],
