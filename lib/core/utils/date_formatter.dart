...
extension DateTimeExtension on DateTime {
  ...
  String fullDateTime() => DateFormat("E, d MMM yyyy HH:mm", locale).format(this);
  ...
  String getMonthNumber() => DateFormat('MM', locale).format(this);
  ...
  String getDayAndDate() => DateFormat('EEEE, MMM dd, yyyy', locale).format(this);
  String getSimpleDayAndDate() => DateFormat('EEEE, dd MMM yyyy', locale).format(this);
}